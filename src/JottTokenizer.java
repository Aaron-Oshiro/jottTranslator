...
public class JottTokenizer {
	...
	private static ArrayList<Token> createTokensPerLine(String jottLine, String fileName, int lineNum) throws Exception {
		...
		for(int i = 0; i < jottLine.length(); i++){
			...
			if(currentCharacter == ';'){
				...
				i++;
				while(i < jottLine.length() && (Character.isAlphabetic(jottLine.charAt(i)) || Character.isDigit(jottLine.charAt(i)))) {
					currentCharacter = jottLine.charAt(i);
